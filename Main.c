...
pthread_create (&thr2, NULL, BinarySearchHeap(HeapArray, HeapBeginning, HeapEnd, y));
pthread_create (&thr3, NULL, BinarySearchHeap(HeapArray, HeapBeginning, HeapEnd, y));
